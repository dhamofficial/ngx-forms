...
describe('Service: Form, Angular Tests', () => {
  ...
  it(
    'should return an input field with pre-defined key',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const key = 'MyInput'
  ...
  it(
    'should return an input field with pre-defined key and options',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const type = 'input'
  ...
  it(
    'should return an email field with pre-defined key',
    inject([NgxFormsService], (service: NgxFormsService) => {
  ...
  it(
    'should return an email field with pre-defined key and options',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const type = 'input'
  ...
  it(
    'should return a password field',
    inject([NgxFormsService], (service: NgxFormsService) => {
  ...
  it(
    'should return an password field with pre-defined key and options',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const type = 'input'
  ...
  it(
    'should return an date field with pre-defined key and options',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const type = 'input'
  ...
  it(
    'should return a textarea field',
    inject([NgxFormsService], (service: NgxFormsService) => {
  ...
  it(
    'should return an textarea field with pre-defined key and options',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const type = 'textarea'
      const templateType = 'text'
  ...
  it(
    'should return an wysiwyg field with pre-defined key and options',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const type = 'wysiwyg'
      const templateType = 'text'
      const key = 'MyWysiwyg'
  ...
  it(
    'should return an select field with pre-defined key and options',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const type = 'select'
      const templateType = 'text'
      const key = 'MtSelect'
  ...
  it(
    'use field() directly to create a field',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const expected = getExpectedField('input', 'text', 'text', 'Text')
  ...
  it(
    'use parseFields to create an array of fields',
    inject([NgxFormsService], (service: NgxFormsService) => {
      const expected = [
